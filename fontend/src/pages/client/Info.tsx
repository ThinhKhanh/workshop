      ...
      <section className="relative bg-blue-200 py-12 md:py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto mb-6">
            ...
            hiện đại, gần gũi. Chúng tôi tự hào với quy trình rang xay thủ công,
            lựa chọn hạt cà phê tốt nhất từ các vùng trồng nổi tiếng.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Cafeio cam kết mang đến những sản phẩm cà phê chất lượng, bảo vệ
                môi trường và phát triển cộng đồng nông dân trồng cà phê Việt
                Nam.
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
              ...
              <p className="text-gray-500 text-sm text-center">
                Kinh nghiệm hơn 10 năm trong lĩnh vực rang xay cà phê thủ công.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
              <img
              ...
              <p className="text-gray-500 text-sm text-center">
                Sáng tạo ra nhiều công thức cà phê đặc biệt, phục vụ khách hàng
                tận tâm.
              </p>
            </div>
          </div>
