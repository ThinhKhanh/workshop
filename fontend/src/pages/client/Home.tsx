          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
                ...
                <p className="text-gray-600 mb-4 text-center">
                  Đậm đà, mạnh mẽ, hàm lượng caffeine cao, phù hợp cho người
                  thích vị truyền thống.
                </p>
                <span className="text-primary font-bold text-lg mb-2">
                  150.000đ/kg
                </span>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 mb-6">
                  Cafeio là thương hiệu cà phê Việt Nam với sứ mệnh mang đến
                  những trải nghiệm cà phê nguyên bản, chất lượng cao và không
                  gian thưởng thức hiện đại, gần gũi. Chúng tôi tự hào với quy
                  trình rang xay thủ công, lựa chọn hạt cà phê tốt nhất từ các
